...
export default function NavbarMd({ value, onChange, className }) {
  ...
  return (
    <div className={`${className} px-10 py-3 space-y-4 w-full bg-white`}>
      {/* row #1: Logo, Navigation and My Account */}
      <div className="flex items-center justify-between gap-12">
        ...
        {/* Right Section: Navigation and My Account */}
